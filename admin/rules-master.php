...
{
  $txtRuleType = mysqli_real_escape_string($conn,$_POST['txtRuleType']);
  ...
  {
      $insquery = "insert into tbl_rules (rule_type,rule_title,rules,date_created) values($txtRuleType,'{$txtRtitle}','{$txtRules}','{$txtDate}')";
  }
...
if(isset($_POST['btnUpdate']))
{
  ...
  $insquery = "update tbl_rules set rule_type=$txtRuleType, rule_title='{$txtRtitle}',rules='{$txtRules}',date_created='{$txtMdate}' where rule_id = $id";
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group">
                                  <label for="txtRuleType">Rule Type *</label>
                                  <select class="form-control" name="txtRuleType" parsley-trigger="change" required>
                                    <option value="">--Select--</option>
                                    <option <?php if($getres1['rule_type']==0) { echo 'Selected'; } ?> value="0">Match</option>
                                    <option <?php if($getres1['rule_type']==1) { echo 'Selected'; } ?> value="1">Lottery</option>
                                  </select>
                                </div>
                              </div>
                              <div class="col-md-12">
