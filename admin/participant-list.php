...
if(isset($_GET['matchId']))
{
  ...
  $selquery = "select P.pubg_id,U.fname,U.lname,U.username,U.email,U.mobile,P.slot, P.id from participant_details as P left join user_details as U on U.id=P.user_id where P.match_id=$matchId order by P.user_id desc";
...
if(isset($_GET['matchId']) & isset($_GET['partiId']))
{
  ...
  $insquery = "delete from participant_details where id={$partiId}";
  if(mysqli_query($conn,$insquery))
  {
    header("Location:participant-list?matchId=".$matchId);
  }
  else
  {
    //echo $insquery;
  ...
  <head>
    ...
    <script language="JavaScript" type="text/javascript">
      function checkDelete(){
          return confirm('Are you sure, you want to remove this participant form match?');
      }
    </script>
  </head>
                            ...
                            <tbody>
                              <?php while ($selres = mysqli_fetch_array($selresult)){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="participant-list.php?matchId=<?php echo $matchId;?>&partiId=<?php echo $selres['id']; ?>" class="remove-row" style="color: #f05050;" data-toggle="tooltip" data-placement="top" title="" data-original-title="Remove Participant" onclick="return checkDelete()"><i class="fa fa-trash-o"></i></a>&nbsp;&nbsp; 
                                    </td>
                                </tr>
                              <?php } ?>
                            </tbody>
