...
$selquery4 = "select * from tbl_faq where id=1";
...
if(isset($_POST['btnUpdate']))
  {
    ...
    $txtDate = date("Y-m-d H:i:s");
      ...
      $updquery = "update tbl_faq set content='$txtDesc', modify_by=$userid, date_modify='$txtDate' where id=1";
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="card-box">
                  ...
                  <h4 class="m-t-0 header-title"><b>FAQ</b></h4>
                  <p class="text-muted font-13 m-b-30">
                      Add/edit faqs here.
                  </p>
                  <form action="faq.php" data-parsley-validate novalidate method="post">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group text-right m-b-0">
                          ...
                          <a href="faq" class="btn btn-default waves-effect waves-light"> Cancel</a>
                        </div>
                      </div>
                    </div>
                  </form>
