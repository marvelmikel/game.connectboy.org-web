  ...
  if(isset($_POST['submit']))
  {
    ...
    {   
        ...
        $fields = array(
                        ...
                        'data' => array("is_announcement" => "1","notification_title" => $notification_title,"notification_msg" => $notification_msg,"tpath2" => $tpath2,"external_link"=>$external_link,"txtDate"=>$txtDate),
