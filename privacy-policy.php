...
$selPrivacy = "select * from tbl_privacy_policy where id=1";
$selresultPrivacy = mysqli_query($conn,$selPrivacy);
$selresPrivacy = mysqli_fetch_array($selresultPrivacy);
...
<html lang="zxx">
	<head>
		...
		<title><?php echo $selres4Nav['app_name']; ?> - Privacy Policy</title>
		...
		<section class="blog-detail" id="blog">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
					    <?php echo $selresPrivacy['content']; ?>
					</div>
				</div>
			</div>
