...
$selAbout = "select * from tbl_about where id=1";
$selresultAbout = mysqli_query($conn,$selAbout);
$selresAbt = mysqli_fetch_array($selresultAbout);
...
<html lang="zxx">
	<head>
		...
		<title><?php echo $selres4Nav['app_name']; ?> - About</title>
